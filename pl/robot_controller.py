...
class Controller(Node):
  ...
  def save_msg_to_file(self, msg, file_path):
    ranges = msg.ranges  # Assuming 'ranges' contains the data you want to save
  ...
  def scan_callback(self, msg):
    ...
    # Save msg to file
    # self.save_msg_to_file(msg, file_path)


  def image_callback(self, msg):
    """
    This method gets called every time an Image message is 
    received on the '/demo/camera1/image_raw' topic 
    """    
    # try:
