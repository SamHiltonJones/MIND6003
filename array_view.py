...
array = np.load('/home/sam/tut/MIND6003/install/office_robot_pkg/share/office_robot_pkg/point_cloud/filtered_pcds/filtered_point_cloud.npy')

filtered_array = array[~np.isinf(array).any(axis=1)]


num_samples = int(0.3 * len(filtered_array))
